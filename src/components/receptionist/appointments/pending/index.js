...
export default function PendingAppointments({user}) {
            ...
            <div className="bodyAll">
                ...
                <div className="pendingContainer">
                        <div className="titlePending">
                            <p className="titleTxt">Pending Appointments</p>
                        </div>
                    <div className="checkBody">
                        ...
                        <TableContainer component={Paper}>
                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                    <TableHead>
                                        <TableRow>
                                            <TableCell style={{fontWeight: "bold"}}>Appointment ID</TableCell>
                                            <TableCell align="center" style={{fontWeight: "bold"}}>Doctor's Name</TableCell>
                                            <TableCell align="center" style={{fontWeight: "bold"}}>Patient ID</TableCell>
                                    ...
                                    <TableBody>
                                        {rows.map((row) => (
                                            ...
                                            <div className="innerItems">
                                                <Tooltip title="Pending Appointment">
                                                <button className="btnBook" style={{backgroundColor: "red"}}>Pending</button>
                                                </Tooltip>
                                            </div>
                                            </TableCell>
                                            </TableRow>
